        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log(
                `New content (${APP_VERSION}) is available.`
              );

              // Automatically apply the update by clearing caches and reloading
              ...
              console.log(`Content (${APP_VERSION}) is cached for offline use.`);
