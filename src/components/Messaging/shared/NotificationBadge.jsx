...
const NotificationBadge = ({ count, showIcon = false, size = 'md', className = '', onClick = null }) => {
  ...
  const Badge = () => (
    <span 
      className={`bg-red-500 text-white rounded-full flex items-center justify-center ${sizeClasses} ${className}`}
      onClick={onClick}
    >
      {countDisplay}
    </span>
